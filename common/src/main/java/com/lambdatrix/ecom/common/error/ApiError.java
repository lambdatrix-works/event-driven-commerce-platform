...
public record ApiError(String errorId, Instant timestamp, String status, ErrorCode errorCode, String message,
	...
	public static final class Builder {
		...
		public ApiError build() {
			return new ApiError(errorId, timestamp, status, errorCode, message, path, correlationId, details);
		}
	}
