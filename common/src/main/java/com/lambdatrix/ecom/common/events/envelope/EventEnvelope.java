...
public record EventEnvelope<T>(String eventId, DomainEventType eventType, String aggregateType, String aggregateId,
		Instant timestamp, Integer version, String correlationId, String causationId, String tenantId, Actor actor,
	...
	public static final class Builder<T> {
		...
		public EventEnvelope<T> build() {
			return new EventEnvelope<T>(eventId, eventType, aggregateType, aggregateId, timestamp, version,
					correlationId, causationId, tenantId, actor, payload, metadata);
		}
